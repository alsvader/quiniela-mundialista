# season-participation Specification

## Purpose

Modelo de temporadas (`grupos` y `eliminatoria`) como agrupación de fases del torneo, participación de cada usuario por temporada, temporada activa configurable por el administrador, entrada tardía a una temporada y migración de los participantes existentes a la temporada de grupos.
