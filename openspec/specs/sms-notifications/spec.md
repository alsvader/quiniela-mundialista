...
Avisos automáticos por SMS para participantes de la temporada de eliminatoria:
recordatorio de inicio de partido cuando el kickoff está próximo y el partido sigue
abierto, con idempotencia por partido, audiencia elegible filtrada, disparo periódico
protegido por secreto e integración con el proveedor SMS Masivos en modo bulk/sandbox.
